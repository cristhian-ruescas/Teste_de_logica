fun main(args: Array<String>) {
    ...
    var sair = "Sim" // variavel para parar o while
    val convidados = mutableMapOf(     // A lista
        1 to "Maria",
        2 to "Fabiano",
        3 to "Cauã",
        4 to "Mariana"
    ...
    while (sair == "Sim") {  // laço de repetição para que possa adicionar ou remover varias vezes
        ...
        if (opcao == 1) {                                  // para adicionar,digitando em 1
        ...
        } else if (opcao == 2) {                           // para remover, digitando em 2
            println("Fale quem você quer tirar: ")
            var tirar = readLine()!!.toInt()

            convidados.remove(tirar)

        } else if (opcao == 3) {      // Aparece os convidados
            println(convidados)

        } else if (opcao == 4) {                  // se pedir para sair mandar mensagem agradecendo o teste
